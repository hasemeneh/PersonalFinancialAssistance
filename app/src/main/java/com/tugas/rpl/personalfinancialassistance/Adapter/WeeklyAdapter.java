...
import com.tugas.rpl.personalfinancialassistance.Model.WeeklyDao;
...
public class WeeklyAdapter extends BaseAdapter {
    ...
    final List<WeeklyDao> data;

    public WeeklyAdapter(Activity activity, List<WeeklyDao> data) {
    ...
    public View getView(int i, View v, ViewGroup viewGroup) {
        if (v == null) {
            ...
            v = inflater.inflate(R.layout.layout_item_harian, null);
        }
        return v;
    }
}
